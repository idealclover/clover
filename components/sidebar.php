...
<div class="col-12 col-lg-4">
        ...
        <div class="card-body">
            ...
            <div class="contact">
                <a href="http://wpa.qq.com/msgrd?v=3&uin=1455169173&site=qq&menu=yes" rel="noreferrer" style="text-decoration: none" target="_blank" title="QQ: 1455169173">
                    <img alt="QQ: 1455169173" width="28px" src="<?php $this->options->themeUrl('assets/icons/QQ.svg'); ?>">
                </a>
                <a href="http://t.me/idealclover" rel="noreferrer" style="text-decoration: none" target="_blank" title="Telegram: @idealclover">
                    <img alt="Telegram: @idealclover" width="28px" src="<?php $this->options->themeUrl('assets/icons/telegram.svg'); ?>">
                </a>
                <a href="mailto:idealclover@163.com" rel="noreferrer" style="text-decoration: none" target="_blank" title="Email: idealclover@163.com">
                    <img alt="Email: idealclover@163.com" width="28px" src="<?php $this->options->themeUrl('assets/icons/mail.svg'); ?>">
                </a>
                <a href="https://twitter.com/idealclover" rel="noreferrer" style="text-decoration: none" target="_blank" title="Twitter: @idealclover">
                    <img alt="Twitter: @idealclover" width="28px" src="<?php $this->options->themeUrl('assets/icons/twitter.svg'); ?>">
                </a>
                <a href="https://weibo.com/idealclover" rel="noreferrer" style="text-decoration: none" target="_blank" title="Weibo: @不蠢会死的某翠">
                    <img alt="Weibo: @不蠢会死的某翠" width="28px" src="<?php $this->options->themeUrl('assets/icons/weibo.svg'); ?>">
                </a>
            </div>
        ...
        <div class="card-body">
            ...
            <div class="shield">
                <a href="https://t.me/idealcloverchannel" rel="noreferrer" style="text-decoration: none" target="_blank">
                    <img alt="telegram" src="https://img.shields.io/badge/dynamic/json?label=Telegram&suffix=%20Subscribers&query=%24.data.totalSubs&url=https%3a%2f%2fapi.spencerwoo.com%2fsubstats%2f%3fsource%3dtelegram%26queryKey%3didealcloverchannel&color=2ca5e0&style=for-the-badge&logo=telegram&longCache=true">
                </a>
            </div>
            <div class="shield">
                <a href="https://idealclover.top/feed" rel="noreferrer" style="text-decoration: none" target="_blank">
                    <img alt="rss" src="https://img.shields.io/badge/dynamic/json?color=ffa500&label=rss%20feed&suffix=%20Subscribers&query=%24.data.totalSubs&url=https%3A%2F%2Fapi.spencerwoo.com%2Fsubstats%2F%3Fsource%3Dinoreader%257Cfeedly%26queryKey%3Dhttps%3A%2F%2Fidealclover.top%2Ffeed&logo=rss&style=for-the-badge&longCache=true">
                </a>
            </div>
            <div class="shield">
                <a href="https://mailchi.mp/7f28311041bc/idealclover" rel="noreferrer" style="text-decoration: none" target="_blank">
                    <img alt="mail" src="https://img.shields.io/badge/dynamic/json?label=Email&suffix=%20Subscribers&query=%24.totalSubs&url=https%3a%2f%2fmailchimp.idealclover.workers.dev&color=168de2&style=for-the-badge&logo=mail.ru&longCache=true">
                </a>
            </div>
            <div class="more">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <iframe title="疫情地图" src="https://www.lovestu.com/api/project/cnmapyinqing/obj.php" height="360" frameborder="no" border="0" width="100%"> </iframe>
        </div>
    </div>
    <div class="card">
        <div class="card-header">

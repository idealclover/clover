...
if (ua.match(/MicroMessenger/i) == "micromessenger") {
  ...
  div.style.cssText =
    "position: fixed; left: 0; top: 0; width: 100%; height: 100%; box-sizing: border-box; padding: 18px; font-size: 16px; line-height: 1.5em; background-color: rgba(0,0,0,.5); z-index: 2147483647; display: flex; justify-content: center; align-items: center;";
  div.innerHTML =
    "" +
